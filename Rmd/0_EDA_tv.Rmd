...
```{r eval=FALSE}
ggsave(file = "~/Desktop/DataComp2018/image/basic/チャンネルごとの従来手法による予測視聴率と総合視聴率の関係性.png", plot = p1, dpi = 100, width = 19.73, height = 9.3)
```
...
```{r eval=FALSE}
ggsave(file = "~/Desktop/DataComp2018/image/basic/番組大分類ごとの従来手法による予測視聴率と総合視聴率の関係性.png", plot = p1, dpi = 100, width = 19.73, height = 9.3)
```
